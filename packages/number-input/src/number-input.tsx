...
export const NumberInput: React.FC<NumberInputProps> = React.forwardRef(
  function NumberInput(props: NumberInputProps, ref: React.Ref<any>) {
 ...
 */
export const NumberInputStepper: React.FC<NumberInputStepperProps> = React.forwardRef(
 ...
 */
export const NumberDecrementStepper: React.FC<NumberDecrementStepperProps> = React.forwardRef(
